...
name: xao-content
description: |
  Tự động xào nấu (tối ưu hóa & viết lại) content Phật pháp/tâm linh từ video YouTube đang mở trong Chrome.
  
  Sử dụng skill này khi bạn:
  - Có video YouTube về Phật pháp, lời Phật dạy, hoặc tâm linh mở trong Chrome
  - Muốn tạo kịch bản chi tiết với cấu trúc dẫn dắt tâm linh chuẩn
  - Cần 5 tiêu đề YouTube hấp dẫn + 3 ý tưởng thumbnail + description + tags
  - Muốn nâng cấp transcript gốc thành content Phật pháp chuyên nghiệp
  
  Skill sẽ tự động: extract caption từ video → phân tích kịch bản → tạo dàn ý 8-10 phần → viết kịch bản hoàn chỉnh → tạo tiêu đề/thumbnail/description/tags.
---

# /xao-content — Tự động xào nấu content Phật pháp từ video YouTube
